...
public class NDArray {
    ...
    public static class SetupState {
        ...
        public INDArray smallArray = Nd4j.ones(1<<8);
        public INDArray mediumArray = Nd4j.ones(1<<16);
        public INDArray largeArray = Nd4j.ones(1<<28);
        static {
    ...
    public void sumNumber_small(SetupState state) {
        state.smallArray.sumNumber().doubleValue();
    }
    @Benchmark @BenchmarkMode(Mode.SampleTime) @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public void sumNumber_medium(SetupState state) {
        state.mediumArray.sumNumber().doubleValue();
    }
    @Benchmark @BenchmarkMode(Mode.SampleTime) @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public void sumNumber_large(SetupState state) {
        state.largeArray.sumNumber().doubleValue();
    }
    ...
    @Benchmark @BenchmarkMode(Mode.SampleTime) @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public void shapeInfoDataBuffer(SetupState state) {
        state.array1.shapeInfoDataBuffer();
    }

    @Benchmark @BenchmarkMode(Mode.SampleTime) @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public void shapeInfo(SetupState state) {
        state.array1.shapeInfo();
    }

    @Benchmark @BenchmarkMode(Mode.SampleTime) @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public void isView(SetupState state) {
        state.array1.isView();
    }

    @Benchmark @BenchmarkMode(Mode.SampleTime) @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public void isWrapAround(SetupState state) {
        state.array1.isWrapAround();
    }

    @Benchmark @BenchmarkMode(Mode.SampleTime) @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public void rank(SetupState state) {
        state.array1.rank();
    }

    @Benchmark @BenchmarkMode(Mode.SampleTime) @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public void stride(SetupState state) {
        state.array1.stride(0);
    }

    @Benchmark @BenchmarkMode(Mode.SampleTime) @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public void elementStride(SetupState state) {
        state.array1.elementStride();
    }

    @Benchmark @BenchmarkMode(Mode.SampleTime) @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public void elementWiseStride(SetupState state) {
        state.array1.elementWiseStride();
    }

    @Benchmark @BenchmarkMode(Mode.SampleTime) @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public void secondaryStride(SetupState state) {
        state.array1.secondaryStride();
    }
}
